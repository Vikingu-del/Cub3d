...
/*   Updated: 2024/04/12 12:38:36 by eseferi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parse_sprites(t_cube *cube)
{
	...
	{
		if (i == DOOR)
			text_info.path = "./textures/bonus_text/walls/door.xpm";
		else if (i == KEY)
			text_info.path = "./textures/bonus_text/sprites/key.xpm";
		else
			text_info.path = "./textures/bonus_text/sprites/knight.xpm";
